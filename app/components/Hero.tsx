        ...
        <div className="text-center lg:text-left">
          <div className="mb-6">
            <h1 className="text-5xl lg:text-7xl font-bold mb-4">
              <span className="gradient-text-primary animate-gradient">Hello, I'm</span>
              <br />
              <span className="text-neutral-900 dark:text-white">Stanley Iyetor</span>
            </h1>
            <p className="text-xl lg:text-2xl text-neutral-600 dark:text-neutral-300 mb-8">
               Full Stack MERN Developer | Python Programmer | Cybersecurity
            Enthusiast
            </p>
