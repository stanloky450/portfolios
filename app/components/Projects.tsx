...
export default function Projects() {
	const projects = [
		{
			title: "ZATCAB An E-hailing Transportation App",
			description:
				"Real-time ride booking and driver matching Integrated navigation system for location tracking In-app passenger-driver communication User-friendly onboarding and ride request flow Optimized mobile performance and responsiveness Trip interaction and transportation workflow automation",
			image: "/assets/zatcab.jpg",
			tags: [
				"React native",
				"React",
				"Node.js",
			...
			github: "#",
			live: "https://play.google.com/store/apps/details?id=com.zatsantify.zatcab/",
		},
		{
			title: "Messengerz A Logistics and Delivery App",
			description:
				"Real-time logistics app that allows booking and driver matching Integrated navigation system for location tracking In-app goods-driver communication User-friendly onboarding seemless with an Optimized mobile performance and responsiveness Trip interaction and transportation workflow automation",
			image: "/assets/messengerz.png",
			tags: [
				"React native",
				"React",
				"Node.js",
			...
			github: "#",
			live: "https://expo.dev/accounts/messengerz/projects/messengerzapp/builds/78349503-9a37-48d8-99f7-6d7304971893/",
		},
		{
	...
	return (
		<section
			id="projects"
			className="py-20 px-4 bg-neutral-50/50 dark:bg-background"
		>
								...
								<div className="flex flex-wrap gap-2">
									{project.tags.map((tag, tagIndex) => (
										<Badge
											key={tagIndex}
											variant="secondary"
											className="bg-blue-900 dark:bg-white text-white  text-sm dark:text-blue-800"
										>
											{tag}
										</Badge>
									))}
